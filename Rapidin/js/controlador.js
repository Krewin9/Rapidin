...
function cambiarUsuarios(){
    ...
    document.querySelector("#saludo").innerHTML = `<p class="font-1 mb-0" style="color:#BC1C2C;">
                                                        ¡Hola ${usuarios[indiceUsu].nombre}!
                                                    </p>`;
    document.querySelector("#bienvenida").innerHTML = `<p class="font-2" style="color:#BC1C2C; font-size:x-large;">
                                                        Bienvenido a Rapid-in
                                                    </p>`;
}
cambiarUsuarios();
    ...
    categorias[indiceCat].empresas.forEach(function(empresa,indiceEmp){
        celda+=`<div class="col-6 mb-3">
                    <div class="card" style="border-radius: 30px; margin-rigtht: .5rem">
                        <img class="card-img-top" src="img/rapidin.png" alt="Card image cap">
                        ...
                        empresa.productos.forEach(function(producto,indicePro){
                            celda+=`<li class="list-group-item d-flex justify-content-between align-items-center">
                                            <span class="font-3">
                                            <span class="font-2" style="color:#BC1C2C">${producto.nombreProducto}<br></span>
    ...
    usuarios[indiceUsu].ordenes.forEach(orden=>{
        celda+=`<div class="row">
                        <div class="col-10 pt-2">
                            <p class="font-2" style="color:#BC1C2C;">${orden.nombreProducto}</p>
